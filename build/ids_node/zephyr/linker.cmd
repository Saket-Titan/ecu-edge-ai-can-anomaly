...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000000 + 0x20000), LENGTH = (0x60000 - 0x1f0)
    RAM (wx) : ORIGIN = 0x24000000, LENGTH = (320 * 1K)
    BACKUP_SRAM ( rw ) : ORIGIN = (947912704), LENGTH = (4096) EXTMEM ( rw ) : ORIGIN = (2415919104), LENGTH = (268435456) SRAM1 ( rw ) : ORIGIN = (805306368), LENGTH = (16384) SRAM2 ( rw ) : ORIGIN = (805322752), LENGTH = (16384) SRAM4 ( rw ) : ORIGIN = (939524096), LENGTH = (16384) DTCM ( rw ) : ORIGIN = (536870912), LENGTH = (131072) ITCM ( rw ) : ORIGIN = (0), LENGTH = (65536)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x8000000 + 0x20000);
    rom_start :
 {
